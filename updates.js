...
>Unit Converter: Added angle, paper, and time unit conversions
>Unit Converter: Added Japanese units of length, volume, and weight, Taiwanese units of area and mass, and some other traditional units of area
...
>Calendar Converter: Fixed date of Berber calendar
...
>Calendar Converter: Fixed a minor glitch with date calculation in years centuries away
...
>Calendar Converter: Fixed an issue with displaying a link for the month of Adar in certain years
...
>Calendar Converter: Fixed an issue in displaying the first day of the week of the Gregorian calendar   

<h3>31 July 2023</h3>
>Calendar Converter: Added the Dilami calendar
>Calendar Converter: Adjusted intercalculation of Solar Hijri and Tabarian calendars
    
<h3>18 July 2023</h3>
>Holidays: Added Shushan Purim, fixed a Tisha B'Av date issue with the Hebrew calendar

<h3>14 July 2023</h3>
>Calendar Converter: Fixed a glitch with the day selector
>Calendar Converter: Moved Javanese, Ethiopian and Coptic's 'first day of week' to Monday
>Website: Minor changes to website appearance

<h3>5 July 2023</h3>
>Calendar Converter: Correction made - the Bengali calendar days start at sunrise
>Calendar Converter: Also corrected the Bengali calendar by one day oops :D
...
<h3>4 July 2023</h3>
>Calendar Converter: Doubled range of almost every calendar to 760 years!
>Calendar Converter: Added Bengali language era name
...
<h3>2 July 2023</h3>
>Calendar Converter: You can now select dates with the Japanese calendar
>Calendar Converter: Almost all calendars now have 380 years searchable (around a 160 year increase from the previous maximum)
>Holidays: Holidays are no longer visible :( But the website loads much faster

<h3>30 June 2023</h3>
>Calendar Converter: You can now select dates with the Mayan calendar

<h3>28 June 2023</h3>
>Calendar Converter: Over half the calendar's months are now underlined and linked to articles
>Calendar Converter: Shows first day of week for every calendar, "not applicable" symbol added
>Calendar Converter: Extended reach of Julian and Kurdish calendars
>Calendar Converter: Added the Japanese calendar

<h3>24 June 2023</h3>
>Calendar Converter: First day now shown for Indian National and Kurdish calendars
>Calendar Converter: Fixed an issue with how first day and day start time was displayed
>Calendar Converter: Old Coptic numerals were added to the Coptic calendar
>Holidays: Shrove Tuesday and Ash Wednesday were added to the Gregorian calendar

<h3>20 June 2023</h3>
>Calendar Converter: Date now displayed under calendar selector
>Calendar Converter: French Republican calendar now selectable
>Calendar Converter: French Republican calendar now shows Roman numerals

<h3>19 June 2023</h3>
>Calendar Converter: Added that the 'day starts at sunset' to Coptic and Ethiopian
>Calendar Converter: Added information on the first day of the week by calendar
>Calendar Converter: Added the Mayan and French Republican calendars
>Calendar Converter: Removed the panel showing day of the week

<h3>4 June 2023</h3>
>Calendar Converter: More calendars can go to 2117 CE now
>Calendar Converter: Fixed issue with selecting Julian calendar
...
<h3>30 May 2023</h3>
>Calendar Converter: Added Javanese calendar (may need more research)
>Calendar Converter: The start of the day (midnight, sunrise, or sunset) is visible on all calendars now
>Calendar Converter: Increasing the reach by over 50 years for half the calendars :)
...
log = `<h1>Updates</h1><p style='text-align:center'>Go to: <a href="#2023">2023</a> | <a href="#2024">2024</a> | <a href="https://letterly.github.io/interbraille.txt" target="_blank">Braille Converter Updates</a> | <a href="https://letterly.github.io/changelog.html" target="_blank">Alphabet Website Updates</a></p>` + log
